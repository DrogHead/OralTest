        ...
        this.initialize = () => {
            ...
            for (let i = 0; i < ripples.length; i++) {
                ...
                let f = (ev: MouseEvent): any => {
                    ...
                    let g = (ev: MouseEvent): any => {

                        element.removeEventListener('mouseleave', g);

                        let h = (ev: MouseEvent): any => {
